...
def bioasq_train(small_data=False, verbose=2, model_type='bert'):
    ...
    if model_type == 'bert':
        ...
        dropout = 0.8
        batch_size=32
        savepath = "./task9b_bert_model_32.pt"
        ...
        dropout = 0.7
        batch_size=32
        savepath = "./task9b_biobert_model_32.pt"
        ...
        dropout = 0.6
        batch_size=32
        savepath = "./task9b_distilbert_model_32.pt"
        ...
        dropout = 0.5
        batch_size=32
        savepath = "./task9b_albert_model_32.pt"
        ...
        dropout = 0.4
        batch_size=32
        savepath = "./task9b_qaalbert8b_model_32.pt"
        
    if small_data:
        nb_epoch = 3
        
    print("Training for BioASQ", model_type, "with batch size", batch_size)
    classifier = Classification('training9b.json', #_reranked.json',
                                'rouge_9b.csv',
...
def bioasq_run(nanswers={"summary": 6,
    ...
    if model_type == 'bert':
        ...
        dropout = 0.8
        batch_size=32
        loadpath = "./task9b_bert_model_32.pt"
    elif model_type == 'biobert':
        rouge_labels = False
        classification_type = 'BioBERT'
        nb_epoch = 1
        dropout = 0.7
        batch_size=32
        loadpath = "./task9b_biobert_model_32.pt"
    elif model_type == 'distilbert':
        rouge_labels = False
        classification_type = 'DistilBERT'
        nb_epoch = 1
        dropout = 0.6
        batch_size=32
        loadpath = "./task9b_distilbert_model_32.pt"
    elif model_type == 'albert':
        rouge_labels = False
        classification_type = 'ALBERT'
        nb_epoch = 5
        dropout = 0.5
        batch_size=32
        loadpath = "./task9b_albert_model_32.pt"
    elif model_type == 'qaalbert':
        rouge_labels = False
        classification_type = 'QA_ALBERT'
        nb_epoch = 5
        dropout = 0.4
        batch_size=32
        loadpath = "./task9b_qaalbert8b_model_32.pt"
...
def loaddata(filename):
    """Load the JSON data
    >>> data = loaddata('training9b.json')
    Loading training9b.json
    >>> len(data)
    3743
    >>> sorted(data[0].keys())
...
def rouge_to_labels(rougeFile, labels, labelsthreshold, metric=["SU4"]):
    ...
    >>> labels = rouge_to_labels("rouge_9b.csv", "topn", 3)
...
if __name__ == "__main__":
    ...
    #bioasq_train(model_type='distilbert')
    ...
    parser.add_argument('-r', '--dropout', type=float, default=0.1,
